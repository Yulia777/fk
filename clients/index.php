...
?>
    ...
    <div id="return/">
        <h2>Возврат</h2>
        <p>Согласно Закону о защите прав потребителя при дистанционном способе продажи Вы вправе отказаться от товара в любое время до его получения и в течение 7 дней после его получения.</p>
        <p>Возврат и обмен товара возможен, если:</p>
        <ul>
            <li>изделие не было использовано</li>
            <li>сохранен его товарный вид (в том числе этикетки, ярлыки)</li>
            <li>сохранена оригинальная упаковка производителя (пакет, коробка и т.д.)</li>
        </ul>
    </div>

...
<?if($arResult['SECTIONS']):?>
	<div class="item-views catalog sections services__container">
		<div class="row margin0 list_block">
            ...
            <h2><?=$arItem['NAME']?></h2>
				<div class="col-md-12 col-sm-12">
					<div class="<?=($bShowSectionImage ? '' : ' wti')?>  <?=$arParams['IMAGE_CATALOG_POSITION'];?>" id="<?=$this->GetEditAreaId($arItem['ID'])?>">

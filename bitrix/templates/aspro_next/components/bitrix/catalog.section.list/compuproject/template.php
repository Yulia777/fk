...
<? if ($arResult['SECTIONS']): ?>
    <div class="sections_wrapper compuproject">
                            ...
                            <? if ($arParams["SHOW_SECTION_LIST_PICTURES"] != "N"):?>
                                <div class="catalog-image">
                                    <? if ($arSection["PICTURE"]["SRC"]):?>
                                        <? $img = CFile::ResizeImageGet($arSection["PICTURE"]["ID"], array("width" => 300, "height" => 200), BX_RESIZE_IMAGE_EXACT, true); ?>
                                        <a href="<?= $arSection["SECTION_PAGE_URL"] ?>"><img src="<?= $img["src"] ?>"
                                    ...
                                    <? elseif ($arSection["~PICTURE"]):?>
                                        <? $img = CFile::ResizeImageGet($arSection["~PICTURE"], array("width" => 300, "height" => 200), BX_RESIZE_IMAGE_EXACT, true); ?>
                                        <a href="<?= $arSection["SECTION_PAGE_URL"] ?>"><img src="<?= $img["src"] ?>"
                                                                                             alt="<?= ($arSection["PICTURE"]["ALT"] ? $arSection["PICTURE"]["ALT"] : $arSection["NAME"]) ?>"
                                                                                             title="<?= ($arSection["PICTURE"]["TITLE"] ? $arSection["PICTURE"]["TITLE"] : $arSection["NAME"]) ?>"/></a>
                                    <? else:?>
                                        <a href="<?= $arSection["SECTION_PAGE_URL"] ?>"><img
                                                    src="<?= SITE_TEMPLATE_PATH ?>/images/catalog_category_noimage.png"

        ...
        <div class="info_item">
            ...
            <div class="buy_block">
                ...
                <?if($arAddToBasketData["ACTION"] == "ADD" && $arAddToBasketData["CAN_BUY"] && $arParams["SHOW_ONE_CLICK_BUY"]!="N"):?>
                    <div class="wrapp_one_click" onclick="yaCounter21932680.reachGoal('buy-one-click'); return true;">
            ...
            <div class="price_txt">
                ...
                <div class="work-conditions">
                    <div class="work-conditions__item">
                        ...
                        <?if($arResult['PROPERTIES']['RYAZAN_DELIVERY']['VALUE']):?>
                            <p class="work-conditions--city">по г.Рязани: <span><?=$arResult['PROPERTIES']['RYAZAN_DELIVERY']['VALUE'];?></span></p>
                        <?endif;?>
                        <?if($arResult['PROPERTIES']['RUSSIAN_DELIVERY']['VALUE']):?>
                            <p class="work-conditions--city">по России: <span><?=$arResult['PROPERTIES']['RUSSIAN_DELIVERY']['VALUE'];?></span></p>
                        <?else:?>
                            <p class="work-conditions--city">по России: <span>N/A</span></p>
                        <?endif;?>
                    ...
                    <div class="work-conditions__item">
                        <p>
                            ...
                            <?if($arResult['PROPERTIES']['PAYMENT_METHOD']['VALUE']):?>
                                Способы оплаты: <span><?=$arResult['PROPERTIES']['PAYMENT_METHOD']['VALUE'];?></span>
                            <?else:?>
                                Способы оплаты: <span>N/A</span>
                            <?endif?>
                        </p>
                    </div>
                    <div class="work-conditions__item">
                        <p>
                            ...
                            <?if($arResult['PROPERTIES']['WARRANTY']['VALUE']):?>
                                Гарантия на оборудование: <span><?=$arResult['PROPERTIES']['WARRANTY']['VALUE'];?></span>
                            <?else:?>
                                Гарантия на оборудование: <span>N/A</span>
                            <?endif;?>
                        </p>
                    </div>
                    <div class="work-conditions__item">
                        <p>
                            ...
                            <?if($arResult['PROPERTIES']['INTALLATION_OF_EQUPMENT']['VALUE']):?>
                                Монтаж оборудования: <span><?=$arResult['PROPERTIES']['INTALLATION_OF_EQUPMENT']['VALUE'];?></span>
                            <?else:?>
                                Монтаж оборудования: <span>N/A</span>
                            <?endif;?>
                        </p>
                    </div>
                </div>

...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	<div id="basket-root" class="bx-basket bx-<?=$arParams['TEMPLATE_THEME']?> bx-step-opacity" style="opacity: 0;">
        ...
        <div class="row">
            <div class="installation-info col-xs-12">
                <H3>Монтаж оборудования</H3>
                <p>
                    Возможно, Вам потребуется также монтаж данного оборудования.<br>
                    Мы обязательно с вами свяжемся и уточним эти нюансы после оформления заказа.
                </p>
            </div>
        </div>
